...
Route::group(
    ...
    function () {
        ...
        Route::get('expense-breakdown', [PaymentController::class, 'expenseBreakdown'])->name('expense-breakdown');
        Route::get('income-breakdown', [RevenueController::class, 'incomeBreakdown'])->name('income-breakdown');
    }
);
...
Route::group(
    ...
    function () {
        ...
        Route::delete('requisition/{id}', [RequisitionController::class, 'destroy'])->name('requisition.destroy');
