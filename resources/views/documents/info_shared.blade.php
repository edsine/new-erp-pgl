...
@endif
 ...
 <div class="locked-content1 lock-input1" >
    ...
    <p class="error-message text-danger" style="display: none;">Incorrect lock code!</p>
        ...
        <div class="card locked-file">
         <div class="locked-contentt">
            @else
     <div >
                    ...
                    @php $n =1; @endphp
                        ...
                        <tr>
                            ...
                            @endif --}}
                                ...
                                <a class="document-link"
                                   href="#" >
                                   <i class="fa fa-folder text-yellow fs-19"></i> @if (!empty($document['cat_name']))
                                   {{ $document['cat_name'] }}  / {{ $document['description'] }}
                                   @endif
                                </a>
                                @endif
...
<div class="mt-5 col-md-7">
    @if (empty($document['document_url'])) 
    <script>
        alert("The requested file is currently unavailable on the server. Please try again later or contact support if the issue persists.");
        ...
        <table class="table" id="datatable1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="{{ getFileUrl($share_document->signature_data) }}" style="width: 100px;height: auto;"/>
                    @else
    {{ "NILL" }}
                    @endif
                </td>
...
document.querySelectorAll('.locked-file11').forEach(function (content) {
    content.addEventListener('click', function () {
        ...
        lockedFile.querySelector('.locked-contentt').style.display = 'none'; // Hide the blurred content
    });
});
...
document.querySelectorAll('.verify-lock-btn').forEach(function (button) {
    button.addEventListener('click', function () {
        ...
        if (enteredCode === correctCode) {
            ...
            lockedFile.querySelector('.locked-contentt').style.display = 'block'; // Show real content
            ...
            lockedFile.querySelectorAll('.locked-contentt').forEach(function (elem) {
