                        ...
                        @endphp
                                <tr>
                                   ...
                                   {{--  <td>{{ $document->created_by_name ?? 'NILL' }}</td> --}}
                                    ...
                                    {{-- <td><a class="document-link" target="_blank" href="{{ getDocumentUrl($document->document_url) }}" onClick="saveData('{{ $document->document_url }}')">{{ substr($document->document_url, 10) }}</a>
                                    </td> --}}
                                    <td>
...
if (history.document_url === history.doc_url) {
    row.append($('<td>').html(truncatedUrl + ' <span class="btn-primary" style="background: green;">current version</span>'));
} else {
