...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{__('Product Reports')}}</h5>
    </div>
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item active" aria-current="page">{{__('All Product')}}</li>
@endsection
@push('css-page')
    ...
    @if(Auth::user()->type == 'company')
        ...
        <div class="col-sm-12">
            <div class="mt-2 " >
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => ['product_report.index'], 'method' => 'GET', 'id' => 'project_report_submit']) }}
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="{{ route('product_report.index') }}" class="btn btn-sm btn-danger" data-toggle="tooltip"
            ...
            <div class="card-header card-body table-border-style">
                <div class="table-responsive">
                    <table class="table datatable">
                                    ...
                                    <td class="">
                                        @can('manage project')
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="{{ route('product_report.show', $project->id) }}" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="{{__('Show')}}" data-original-title="{{__('Detail')}}">
                                        ...
                                        @can('edit project')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ URL::to('projects/'.$project->id.'/edit') }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-title="{{__('Edit Product')}}">
                        ...
                        @else
                            <tr>
                                <th scope="col" colspan="7"><h6 class="text-center">{{__('No Products Found.')}}</h6></th>
                            </tr>
                        @endif
