...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('product_report.index')}}">{{__('Product Report')}}</a></li>
                            ...
                            <div class="row align-items-center">
                                <div class="col-7">
                                    <table class="table" >
                                        <tbody>
                                        <tr class="border-0" >
                                            <th class="border-0" >{{ __('Product Name')}}:</th>
                                            <td class="border-0"> {{$project->project_name}}</td>
                                        </tr>
                                        <tr>
                                            <th class="border-0">{{ __('Product Status')}}:</th>
                                            <td class="border-0">
                ...
                <div class="col-md-12  row d-sm-flex align-items-center justify-content-end">
                    <div class="col-1">
                        <button class=" btn btn-primary mx-2 btn-filter apply">
                            <a href="{{ route('product_report.export',$project->id)}}" class="text-white">{{ __('Export') }}</a>
                        </button>
                    </div>
                </div>
            </div>
