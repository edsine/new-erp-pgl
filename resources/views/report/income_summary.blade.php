    ...
    <div id="printableArea">
        <div class="row mt-3">
            ...
            @if ($filter['account'] != __('All'))
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0">{{ __('Bank Account') }} :</h7>
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            <table class="table ">
                                ...
                                @endforeach --}}
                                    <tr>
                                        <td colspan="13" class="text-dark"><span>{{ __('Income = Revenue:') }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-dark">
                                        ...
                                        @foreach ($chartIncomeArr as $i => $income)
                                            <td><a
                                                    href="{{ route('income-breakdown') }}?month={{ $i + 1 }}">{{ \Auth::user()->priceFormat($income) }}</a>
                                            </td>
                                        @endforeach
                                    </tr>
                                </tbody>
