        ...
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                ...
                @if (Gate::check('show hrm dashboard') || Gate::check('show project dashboard') || Gate::check('show account dashboard'))
                    ...
                    @if (\Auth::user()->show_project() == 1)
                        @if (Gate::check('manage project'))
                            <li
                                ...
                                <a href="#!" class="dash-link"><span class="dash-micon"><i
                                            class="ti ti-share"></i></span><span
                                        class="dash-mtext">{{ __('Product System') }}</span><span
                                        class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                                    @can('manage project')
                                        <li
                                            class="dash-item  {{ Request::segment(1) == 'project_products' || Request::route()->getName() == 'project_products.list' || Request::route()->getName() == 'project_products.list' || Request::route()->getName() == 'project_products.index' || Request::route()->getName() == 'project_products.show' || request()->is('project_products/*') ? 'active' : '' }}">
                                            <a class="dash-link"
                    ...
                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'staff_leave' ? 'active' : '' }}">
                        <a href="{{ route('staff_leave.index') }}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-file"></i></span><span
                                class="dash-mtext">{{ __('Leave Manager') }}</span>
                        </a>
                    </li>
                    ...
                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'support' ? 'active' : '' }}">
                        <a href="{{ route('support.index') }}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-headphones"></i></span><span
                                class="dash-mtext">{{ __('Ticketing System') }}</span>
                        </a>
                    </li>
                    <li
                    ...
                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'chats' ? 'active' : '' }}">
                        <a href="{{ url('chats') }}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-message-circle"></i></span><span
                                class="dash-mtext">{{ __('Chat Messenger') }}</span>
                        </a>
                    </li>
                    @if (\Auth::user()->type == 'company')
                        <li
