...
<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="py-1">
            <span class="text-muted">  {{(Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright PGL') }} {{ date('Y') }}</span>
        </div>
...
<script src="{{ asset('assets/js/bootstrap-4.0.0.min.js') }}"></script>
