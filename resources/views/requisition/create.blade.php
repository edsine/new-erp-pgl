                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-icon-user">
                                    {{Form::date('requisition_date',null,array('class'=>'form-control','required'=>'required'))}}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-icon-user">
                                    ...
                                    {{ Form::text('ref_number', '', array('class' => 'form-control','readonly')) }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="table-responsive">
                <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                    ...
                    <tr>
                        ...
                        <th>{{__('Quantity')}}</th>
                        <th>{{__('Rate')}} </th>
                        <th class="text-end">{{__('Amount')}} <br><small class="text-danger font-weight-bold"></small></th>
                        <th></th>
                    </tr>
                    </thead>
                    ...
                    <tr>
                        ...
                        <td width="25%" class="form-group pt-0">
                            {{ Form::text('item','', array('class' => 'form-control item','required'=>'required','placeholder'=>__('Item'),'required'=>'required')) }}
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="form-group price-input input-group search-form">
                                {{ Form::number('rate','', array('class' => 'form-control rate','required'=>'required','placeholder'=>__('Rate'),'required'=>'required')) }}
...
<div class="modal-footer">
    ...
    <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("requisition.index")}}'" class="btn btn-light">
