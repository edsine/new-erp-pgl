                            ...
                            <div class="row">
                                ...
                                <div class="row mt-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" data-toggle="switchbutton"
                                                            ...
                                                            name="gdpr_cookie"
                                                            id="gdpr_cookie"{{ isset($settings['gdpr_cookie']) && $settings['gdpr_cookie'] == 'on' ? 'checked="checked"' : '' }}>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row col-md-12 ">
                                        <div class="form-group ">
                                            {{ Form::label('cookie_text', __('GDPR Cookie Text'), ['class' => 'fulltime col-form-label text-dark text-dark']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select type="text" name="site_date_format" class="form-control selectric"
                                        ...
                                        <option value="d-m-Y"
                                            @if (@$settings['site_date_format'] == 'dd-mm-YYYY') selected="selected" @endif>dd-mm-yyyy</option>
                                        <option value="m-d-Y"
                                            @if (@$settings['site_date_format'] == 'mm-dd-YYYY') selected="selected" @endif>mm-dd-yyyy</option>
                                        <option value="Y-m-d"
                                            @if (@$settings['site_date_format'] == 'YYYY-mm-dd') selected="selected" @endif>yyyy-mm-dd</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('pusher_app_id', env('PUSHER_APP_ID'), ['class' => 'form-control font-style']) }}
                                        @error('pusher_app_id')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('pusher_app_key', env('PUSHER_APP_KEY'), ['class' => 'form-control font-style']) }}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('pusher_app_secret', env('PUSHER_APP_SECRET'), ['class' => 'form-control font-style']) }}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('pusher_app_cluster', env('PUSHER_APP_CLUSTER'), ['class' => 'form-control font-style']) }}
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    <div class=" form-switch">
                                        <input type="checkbox" class="form-check-input" name="recaptcha_module"
                                            id="recaptcha_module" value="on"
                                            {{ env('RECAPTCHA_MODULE') == 'on' ? 'checked="checked"' : '' }}>
