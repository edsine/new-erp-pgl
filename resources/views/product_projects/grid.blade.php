            ...
            <div class="col-md-6 col-xxl-3">
                <div class="card">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    @can('create project')
                                        <a class="dropdown-item" data-ajax-popup="true" data-size="md"
                                            data-title="{{ __('Duplicate Product') }}"
                                    ...
                                    @can('edit project')
                                        <a href="#!" data-size="lg"
                                            ...
                                            class="dropdown-item" data-bs-original-title="{{ __('Edit Product') }}">
                    ...
                    <div style="text-align: center;margin-top: 10px;">
                        <a href="{{ route('projects.show', $project) }}" class="btn btn-sm btn-primary action-item"
                            role="button" aria-haspopup="true" aria-expanded="false">
                            <span class="btn-inner--icon">{{ __('View Product') }}</span>
                        </a>
                    </div>
...
<div class="col-xl-12 col-lg-12 col-sm-12">
    <div class="card">
        <div class="card-body">
            <h6 class="text-center mb-0">{{ __('No Products Found.') }}</h6>
        </div>
    </div>
</div>
@endif
