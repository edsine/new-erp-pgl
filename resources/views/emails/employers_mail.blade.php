                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Welcome to NIWA Express!
                                    </p>
                                    <p style="margin-bottom: 10px;">We are pleased to have you on board, your account is verified 
                                        and ready for use. You can proceed now to login here, with credentials below. 
                                         <a style="color: #0fac81; text-decoration:none;"
                                            target="_blank" href="https://express.niwa.gov.ng">log in here</a> with
                                        credentials below.</p>
                                    <p style="margin-bottom: 10px;">
                                        Username: {{ $employer->company_email }}<br>
                                        Password: {{ $password }}
                                    </p>
                                    <p style="margin-bottom: 10px;">Once you are logged in you will be able  to access the following features:
                                    <ul style="padding-left: 20px;">
                                        <li>View and update your profile</li>
                                        <li>Apply for all types of services</li>
                                    ...
                                    <p style="margin-bottom: 15px;">We hope you find the portal to be a convenient and
                                        ...
                                        contact us at <br>
                                        Email Area Manager: <a style="color: #0fac81; text-decoration:none;"
                                            href="mailto:{{ auth()->user()->areaManager()->email }}">{{ auth()->user()->areaManager()->email }}</a>,<br>
                                        Call Area Manager: <a style="color: #0fac81; text-decoration:none;"
                                            href="tel:{{ auth()->user()->areaManager()->phone }}">{{ auth()->user()->areaManager()->phone }}</a>, or visit our website
