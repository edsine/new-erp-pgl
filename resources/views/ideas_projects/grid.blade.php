                ...
                <div class="card">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    @can('edit project')
                                        <a href="#!" data-size="lg"
                                            ...
                                            class="dropdown-item" data-bs-original-title="{{ __('Edit Idea') }}">
                    ...
                    <div style="text-align: center;margin-top: 10px;">
                        <a href="{{ route('projects.show', $project) }}" class="btn btn-sm btn-primary action-item"
                            ...
                            <span class="btn-inner--icon">{{ __('View Idea') }}</span>
                        </a>
                    </div>
...
<div class="col-xl-12 col-lg-12 col-sm-12">
    <div class="card">
        <div class="card-body">
            <h6 class="text-center mb-0">{{ __('No Ideas Found.') }}</h6>
        </div>
    </div>
</div>
@endif
