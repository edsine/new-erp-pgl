                            ...
                            <table class="table table-flush">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Contract Sum</td>
                                        <td></td>
                                        <td><?php echo e(!empty($data['contract_sum']) ? $data['contract_sum'] : '0'); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Local Tax</td>
                                        <td></td>
                                        <td><?php echo e(!empty($data['tax_amount']) ? $data['tax_amount'] : '0'); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Net Contract Sum</td>
                                        <td></td>
                                        <td><?php echo e(!empty($data['net_contract_sum']) ? $data['net_contract_sum'] : '0'); ?></td>
                                    </tr>
                                    <tr>
                                        <td>Revenue received</td>
                                        <td><?php echo e(!empty($data['revenue']) ? $data['revenue'] : '0'); ?></td>
                                        <td></td>
                                    </tr>

                                    <tr>
                                        <td>Balance to be paid</td>
                                        <td><?php echo e(!empty($data['balance_to_be_paid']) ? $data['balance_to_be_paid'] : '0'); ?></td>
                                        <td></td>
                                    </tr>

                                    <tr>
                                        <td>Expected Net Profit</td>
                                        <td><?php echo e(!empty($data['expected_net_profit']) ? $data['expected_net_profit'] : '0'); ?></td>
                                        <td></td>
                                    </tr>
                                ...
                                <tfooter>
                                    ...
                                    <td><?php echo e(!empty($data['actual_net_profit']) ? ($data['actual_net_profit'] > 0 ? $data['actual_net_profit'] : '') : ''); ?></td>
                                    <td>(<?php echo e(!empty($data['actual_net_profit']) ? ($data['actual_net_profit'] < 0 ? abs($data['actual_net_profit']) : '') : ''); ?>)</td>
                                </tfooter>
                            </table>
