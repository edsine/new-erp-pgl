                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit training type')): ?>
                                            <a href="#" data-url="<?php echo e(route('trainingtype.edit',$trainingtype->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Training Type')); ?>" class="edit-icon"><i class="ti ti-pencil text-white"></i></a>
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/trainingtype/index.blade.php ENDPATH**/ ?>