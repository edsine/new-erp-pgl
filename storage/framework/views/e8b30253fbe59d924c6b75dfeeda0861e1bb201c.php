...
<head>
    ...
    <link rel="icon"
          href="<?php echo e($logo . '/' . (isset($companySettings['company_favicon']) && !empty($companySettings['company_favicon']) ?
        ...
        <div class="container">
            <div class="row row-grid justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <h2 class="h1"><?php echo e(__('Job openings')); ?></h2>
    ...
    <section class="slice slice-lg bg-secondary">
        ...
        <div class="container">
            <div class="mb-4 text-center">
                <h3 class=" mt-3"><?php echo e(__('We help businesses grow')); ?></h3>
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body media-body-custom">
                                                <a href="<?php echo e(route('job.requirement', [$job->code, !empty($job) ? (!empty($job->createdBy->lang) ? $job->createdBy->lang : 'en') : 'en'])); ?>"
                                                   class="h6 mb-0"><?php echo e($job->title); ?></a>
                                            </div>
                                        </div>
                                    </th>
                                    <td>
            ...
            <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top">
                <div class="col-md-6">
                    <div class="copyright text-sm font-weight-bold text-center text-md-left">
                        <?php echo e(!empty($companySettings['footer_text']) ? $companySettings['footer_text']->value : 'ERPGo SaaS'); ?>
...
<?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/job/career.blade.php ENDPATH**/ ?>