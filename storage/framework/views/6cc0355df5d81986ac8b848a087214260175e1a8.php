                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class=" select form-control " id="department_id" name="department_id"  >
                                    ...
                                    <?php $__currentLoopData = $departmentData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e($key==$employee->department_id?'selected':''); ?>><?php echo e($val); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/employee/edit.blade.php ENDPATH**/ ?>