    ...
    <div id="printableArea">
        <div class="row mt-3">
            ...
            <?php if($filter['account'] != __('All')): ?>
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h7 class="report-text gray-text mb-0"><?php echo e(__('Bank Account')); ?> :</h7>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="13" class="text-dark"><span><?php echo e(__('Expense = Payment')); ?></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-dark">
