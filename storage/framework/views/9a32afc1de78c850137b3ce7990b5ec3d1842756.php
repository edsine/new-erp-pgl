...
<?php $__env->startSection('content'); ?>
    ...
    <div id="printableArea">
        <div class="row mt-2">
            <div class="col">
                <input type="hidden"
                    value="<?php echo e(__('Ledger') . ' ' . 'Report of' . ' ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange']); ?>"
                    id="filename">
                ...
                <div class="col">
                    <div class="card p-4 mb-4">
                        ...
                        <h7 class="text-sm mb-0">
                            <?php echo e($filter['balance'] > 0 ? __('Cr') . '. ' . \Auth::user()->priceFormat(abs($filter['balance'])) : __('Dr') . '. ' . \Auth::user()->priceFormat(abs($filter['balance']))); ?>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $journalItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="Id">
                                                <a href="<?php echo e(route('journal-entry.show', $item->journal)); ?>"
                                                    class="btn btn-outline-primary"><?php echo e(AUth::user()->journalNumberFormat($item->journal_id)); ?></a>
                                            </td>
