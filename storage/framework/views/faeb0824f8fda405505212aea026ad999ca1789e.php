                                        ...
                                        <div class="avatar-group">
                                            <?php $__currentLoopData = $asset->users($asset->employee_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="#" class="avatar rounded-circle avatar-sm avatar-group">
                                                    <img alt="" <?php if(!empty($user->avatar)): ?> src="<?php echo e($profile.'/'.$user->avatar); ?>" <?php else: ?> src="<?php echo e(asset('/storage/uploads/avatar/avatar.png')); ?>" <?php endif; ?> data-original-title="<?php echo e((!empty($user)?$user->name:'')); ?>" data-bs-toggle="tooltip" data-original-title="<?php echo e((!empty($user)?$user->name:'')); ?>" class="">
                                                </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/assets/index.blade.php ENDPATH**/ ?>