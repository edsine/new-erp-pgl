                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit award type')): ?>
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                   data-url="<?php echo e(URL::to('awardtype/'.$awardtype->id.'/edit')); ?>" data-ajax-popup="true"
                                                   data-title="<?php echo e(__('Edit Award Type')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/awardtype/index.blade.php ENDPATH**/ ?>