<?php echo e(Form::model($revenue, ['route' => ['revenue.update', $revenue->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data'])); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <img id="image" src="<?php echo e(asset(Storage::url('uploads/revenue')) . '/' . $revenue->add_receipt); ?>"
...
<script>
    ...
    if (revenueType == 1) {
        ...
        $.ajax({
            ...
            success: function(data) {
                const currentProjectId = "<?php echo e($revenue->project_id); ?>";
                $('#project_id').empty();
                $.each(data, function(key, value) {
...
<?php /**PATH C:\laragon\projects\new-erp-pgl\resources\views/revenue/edit.blade.php ENDPATH**/ ?>