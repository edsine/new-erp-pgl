<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Profit and Loss Statement')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Profit and Loss Statement')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="printableArea">
        <div class="row mt-2">
            <div class="col">
                <input type="hidden"
                    value="<?php echo e(__('Profit and Loss Statement') . ' ' . 'Report of' . ' ' . $filter['startDateRange'] . ' to ' . $filter['endDateRange']); ?>"
                    id="filename">
                <div class="card p-4 mb-4">
                    <h6 class="mb-0"><?php echo e(__('Report')); ?> :</h6>
                    <h7 class="text-sm mb-0"><?php echo e(__('Profit and Loss Statement')); ?></h7>
                </div>
            </div>
        ...
        <div class="card p-4 mb-4">
            <h6 class="mb-0"><?php echo e(__('Net Profit/Loss')); ?> :
                <?php echo e(\Auth::user()->priceFormat($amounts['Income'] + $amounts['Expense'])); ?></h6>
        </div>
