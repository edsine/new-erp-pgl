...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create leave')): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('leave.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip"
                title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create Leave')); ?>" class="btn btn-sm btn-primary">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="wrap-table-column"><?php echo e($leave->leave_reason); ?></td>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="#"
                                                        ...
                                                        class="mx-3 btn btn-sm  align-items-center" data-bs-toggle="tooltip"
                                                        title="<?php echo e(__('Leave Action')); ?>"
                                                        data-original-title="<?php echo e(__('Leave Action')); ?>">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete leave')): ?>
                                                    <div class="action-btn bg-danger ms-2">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            data-confirm-yes="document.getElementById('delete-form-<?php echo e($leave->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/leave/index.blade.php ENDPATH**/ ?>