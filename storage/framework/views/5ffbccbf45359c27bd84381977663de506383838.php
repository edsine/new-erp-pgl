<?php echo e(Form::open(['url' => 'payment', 'enctype' => 'multipart/form-data'])); ?>
...
<div class="modal-body">
    <div class="row">
        ...
        <div id="client_dropdown" class="form-group col-md-6 d-none">
            ...
            <?php echo e(Form::select('client_id', $customers, null, ['class' => 'form-control select', 'id' => 'client_id'])); ?>

        </div>
        <div id="project_dropdown" class="form-group col-md-6 d-none">
            <?php echo e(Form::label('project_id', __('Project'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::select('project_id', ['' => 'Select...'], null, ['class' => 'form-control select', 'id' => 'project_id'])); ?>
        ...
        <div id="department_dropdown" class="form-group col-md-6 d-none">
            ...
            <?php echo e(Form::select('department_id', $departments, null, ['class' => 'form-control select', 'id' => 'department_id'])); ?>
...
<?php /**PATH C:\laragon\projects\new-erp-pgl\resources\views/payment/create.blade.php ENDPATH**/ ?>