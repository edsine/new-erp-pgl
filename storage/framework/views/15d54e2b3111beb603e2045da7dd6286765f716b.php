...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create revenue')): ?>
            <a href="#" data-url="<?php echo e(route('revenue.create')); ?>" data-size="lg" data-ajax-popup="true"
                data-title="<?php echo e(__('Create New Revenue')); ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['revenue.index'], 'method' => 'GET', 'id' => 'revenue_form'])); ?>
                            ...
                            <div class="col-xl-10">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <?php echo e(Form::text('date', isset($_GET['date']) ? $_GET['date'] : null, ['class' => 'form-control month-btn', 'id' => 'pc-daterangepicker-1', 'readonly'])); ?>
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <a href="<?php echo e(route('revenue.index')); ?>" class="btn btn-sm btn-danger "
                                        ...
                                        <td>
                                            <?php if(!empty($revenue->add_receipt)): ?>
                                                <a class="action-btn bg-primary ms-2 btn btn-sm align-items-center"
                                                    href="<?php echo e($revenuepath . '/' . $revenue->add_receipt); ?>" download="">
                                                    <i class="ti ti-download text-white"></i>
                                                </a>
                                                <a href="<?php echo e($revenuepath . '/' . $revenue->add_receipt); ?>"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit revenue')): ?>
                                                        <div class="action-btn bg-primary ms-2">
                                                            <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                                ...
                                                                title="<?php echo e(__('Edit')); ?>" title="<?php echo e(__('Edit')); ?>"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete revenue')): ?>
                                                        <div class="action-btn bg-danger ms-2">
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                data-confirm-yes="document.getElementById('delete-form-<?php echo e($revenue->id); ?>').submit();">
