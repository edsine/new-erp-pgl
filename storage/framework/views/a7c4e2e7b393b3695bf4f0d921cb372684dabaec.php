                ...
                <div class="card-body">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto text-end">
                            ...
                            <small class="text-muted"><span class="text-success"><?php echo e($home_data['total_project']['percentage']); ?>%</span> <?php echo e(__('completed')); ?></small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto text-end">
                            ...
                            <small class="text-muted"><span class="text-success"><?php echo e($home_data['total_task']['percentage']); ?>%</span> <?php echo e(__('completed')); ?></small>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/dashboard/project-dashboard.blade.php ENDPATH**/ ?>