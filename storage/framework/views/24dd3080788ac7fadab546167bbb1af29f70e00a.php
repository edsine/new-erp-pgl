        ...
        <div class="col-md-6 form-group">
            ...
            <div class="choose-file">
                <label for="document" class="form-label">
                    ...
                    <img id="image" src="<?php echo e(asset(Storage::url('uploads/documentUpload')).'/'.$ducumentUpload->document); ?>" class="mt-3" style="width:25%;"/>
                </label>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/documentUpload/edit.blade.php ENDPATH**/ ?>