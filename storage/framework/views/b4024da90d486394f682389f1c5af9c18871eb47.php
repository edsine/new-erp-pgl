<div class="col-form-label">
    <div class="row px-3">
        <div class="col-md-4 mb-3">
            <h6 class="emp-title mb-0"><?php echo e(__('Employee')); ?></h6>
            <h6 class="emp-title black-text"><?php echo e(!empty($payslip->employees)? \Auth::user()->employeeIdFormat( $payslip->employees->employee_id):''); ?></h6>
        </div>
        <div class="col-md-4 mb-3">
            <h6 class="emp-title mb-0"><?php echo e(__('Basic Salary')); ?></h6>
            <h6 class="emp-title black-text"><?php echo e(\Auth::user()->priceFormat( $payslip->basic_salary)); ?></h6>
        </div>
        <div class="col-md-4 mb-3">
            <h6 class="emp-title mb-0"><?php echo e(__('Payroll Month')); ?></h6>
            <h6 class="emp-title black-text"><?php echo e(\Auth::user()->dateFormat( $payslip->salary_month)); ?></h6>
        </div>
...
<?php /**PATH C:\laragon\www\pglnigeriaerp\resources\views/payslip/salaryEdit.blade.php ENDPATH**/ ?>