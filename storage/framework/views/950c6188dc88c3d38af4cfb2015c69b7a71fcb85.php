                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('vender', $vender, isset($_GET['vender']) ? $_GET['vender'] : '', ['class' => 'form-control select', 'id' => 'choices-multiple1'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('customer', $customers, isset($_GET['customer']) ? $_GET['customer'] : '', ['class' => 'form-control select', 'id' => 'choices-multiple1'])); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('department', $departments, isset($_GET['department']) ? $_GET['department'] : '', ['class' => 'form-control select', 'id' => 'choices-multiple1'])); ?>
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div clas="col-auto">
                                        ...
                                        <a href="<?php echo e(route('payment.index')); ?>" class="btn btn-sm btn-danger"
