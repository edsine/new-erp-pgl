                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table class="table table-flush border">
                                                    <tbody>
                                                    <tr>
                                                        <td colspan="13" class="text-dark"><span><?php echo e(__('Total Income =  Revenue')); ?></span></td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table class="table table-flush border" id="dataTable-manual">
                                                        <tbody>
                                                        <tr>
                                                            <td colspan="13" class="text-dark"><span><?php echo e(__('Total Expense =  Payment')); ?></span></td>
                                                        </tr>
                                                        <tr>
