...
<div class="bill-preview-main" id="boxes">
    <div class="bill-header" style="">
        ...
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 25px; font-weight: bold; margin-bottom: 15px;"><?php echo e(__('BILL')); ?></h3>
...
<?php /**PATH C:\laragon\projects\new-erp-pgl\resources\views/bill/templates/template2.blade.php ENDPATH**/ ?>