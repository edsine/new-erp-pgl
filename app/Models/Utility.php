...
class Utility extends Model
{
    public static function settings()
    {
        ...
        $settings = [
            "site_currency" => "NGN",
            "site_currency_symbol" => "N",
            "site_currency_symbol_position" => "pre",
            "site_date_format" => "M j, Y",
            "site_time_format" => "g:i A",
            "company_name" => "Pyrich Group Limited",
            "company_address" => "3 R.A Adeleye Close, Utako, Abuja",
            "company_city" => "Abuja",
            "company_state" => "F.C.T",
            "company_zipcode" => "",
            "company_country" => "Nigeria",
            "company_telephone" => "",
            "company_email" => "info@pglnigeria.com",
            "company_email_from_name" => "info@pglnigeria.com",
            "invoice_prefix" => "#INVO",
            "journal_prefix" => "#JUR",
...
',
    ...
    public static function projectAmountPaid($id, $amount, $type)
    {
        $project = Project::find($id);
        if ($project) {

            if ($type == 'credit') {
                $oldBalance                   = $project->amount_paid;
                $project->amount_paid = $oldBalance + $amount;
                $project->save();
            } elseif ($type == 'debit') {
                $oldBalance                   = $project->amount_paid;
                $project->amount_paid = $oldBalance - $amount;
