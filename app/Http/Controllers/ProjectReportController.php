...
class ProjectReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $projects = $projects->where('project_product_type', 0)->orderby('id', 'desc')->get();
    ...
    public function indexProduct(Request $request)
    {
        ...
        $projects = $projects->where('project_product_type', 1)->orderby('id', 'desc')->get();

        return view('product_report.index', compact('projects', 'users', 'status'));
    }
