...
class ProjectProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (\Auth::user()->can('create project')) {
            ...
            return redirect()->route('product_projects.index')->with('success', __('Project Add Successfully'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
    }
    ...
    public function show(Project $project)
    {
        ...
        if (\Auth::user()->can('view project')) {
            ...
            if (in_array($project->id, $user_projects)) {
                ...
                $project_data['revenue'] = [
                    'allocated' => $project->budget,
                    'total' => $revenueAmt,
                    'percentage' => Utility::getPercentage($revenueAmt, $project->budget),
                ];
                // end revenue
